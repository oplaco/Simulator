...
/**
 * This class implements the logic presented by Anthony Narkawicz, César A Muñoz 
 * and Aaron Dutle on their paper: "Coordination Logic for Repulsive Resolution Manuevers"
 * @author Gabriel Alfonsín Espín
 * 
 */
public class RA_Solver implements ResolutionAdvisorySolver{
    
    public double calculate_tcpa(Vector2D S, Vector2D V){
    ...
    * Calculates tau, this time is an estimate (BUT NOT THE SAME) of the time of closest point of approach.
     ...
     * @return 
    */
    public double calculate_tau(Vector2D S, Vector2D V){
        if(!V.equals(new Vector2D(0, 0))){
